...
public class VeiculoController {
    ...
    public Response update(@PathParam("id") Long id, VeiculoDto input){
        try {
            Veiculo updated = (Veiculo) this.veiculoService.update(new Veiculo(id, input.marca(), input.modelo(), input.ano(), input.documentoVeiculo(), input.placaVeiculo(), input.idPessoa()));
